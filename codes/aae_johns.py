...
class AAE_johns:
    def __init__(self, 
                 data_file="../dataset/AAE_supervised/calibration_nm2018.txt", 
...
if __name__ == "__main__":
    ...
    aae_johns = AAE_johns(data_file=data_file, model_name="aae_johns")
    aae_johns.train(num_epochs=600, pretrained_checkpoints=None, supervise_freq=1)
